...
const members = {
    ...
    previousMonth   :"January-25", // new addDecember
    ...
    "01814843266":{
        ...
        post_payable        :2430,
        previous_paid       :4500,
        previous_dining_cost:1430,
        payment             :{"03/02/24-Cash":4000},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2220,
        running_paid    :4000,
        running_meal    :31,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        post_payable        :3406,
        previous_paid       :4810,
        previous_dining_cost:1375,
        payment             :{"09/02/24-Cash":2000,"21/02/24-DBBL":500,"26/02/24-Cash":400,"28/02/24-Cash":1000},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2631,
        running_paid    :3900,
        running_meal    :26,
        // method calling
        preMonth,
    ...
    "01744459622":{
        ...
        post_payable        :4110,
        previous_paid       :4630,
        previous_dining_cost:1373,
        payment             :{"13/02/24-Cash":2000},
        // running month
        stay_cost       :2700,
        garage_cost     :200,
        running_payable :4413,
        running_paid    :2000,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01780608997":{
        ...
        post_payable        :4018,
        previous_paid       :6500,
        previous_dining_cost:2145,
        payment             :{"10/02/24-Cash":5000,"26/02/24-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3823,
        running_paid    :5500,
        running_meal    :33,
        // method calling
        preMonth,
    ...
    "01644377150":{
        ...
        post_payable        :3468,
        previous_paid       :4500,
        previous_dining_cost:1210,
        payment             :{"13/02/24-Bkash":4000,"20/02/24-Bkash":1000},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :3238,
        running_paid    :5000,
        running_meal    :56,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        payment             :{"06/02/24-Cash":2000,"09/02/24-Cash":5000,"24/02/24-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :5000,
        running_paid    :7500,
        running_meal    :56,
        // method calling
        preMonth,
    ...
    "01714443406":{
        ...
        post_payable        :3975,
        previous_paid       :5000,
        previous_dining_cost:1760,
        payment             :{"01/02/25-Bkash":2000,"13/02/25-Bkash":3000,"25/02/25-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4395,
        running_paid    :5500,
        running_meal    :30,
        // method calling
        preMonth,
    ...
    "01749244430":{
        ...
        post_payable        :4841,
        previous_paid       :6500,
        previous_dining_cost:1815,
        payment             :{"06/02/25-Cash":6000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4316,
        running_paid    :6000,
        running_meal    :26,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        post_payable        :1000,
        previous_paid       :4500,
        previous_dining_cost:2860,
        payment             :{"07/02/25-Cash":500,"09/02/25-Cash":500,"13/02/25-Cash":500,"14/02/25-Cash":1500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :-640,
